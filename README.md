...
```javascript
mean = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-mean@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/stats-base-mean/tags). For example,

```javascript
mean = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-base-mean@v0.2.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var mean = require( 'path/to/vendor/umd/stats-base-mean/index.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-base-mean/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/stats-base-mean/actions/workflows/test.yml?query=branch:v0.2.0
...
[deno-readme]: https://github.com/stdlib-js/stats-base-mean/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/stats-base-mean/tree/umd
[umd-readme]: https://github.com/stdlib-js/stats-base-mean/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/stats-base-mean/tree/esm
[esm-readme]: https://github.com/stdlib-js/stats-base-mean/blob/esm/README.md
